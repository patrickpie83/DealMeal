import"./bootstrap.min-d005857b.js";import"./admin-header-663d3a3c.js";const c=document.querySelector(".releaseCouponForm"),b=document.querySelector("#releaseCouponDate"),i=document.querySelector("#releaseCouponId"),d=document.querySelector("#releaseCouponName"),u=document.querySelector("#releaseCouponUsage"),p=document.querySelector("#releaseCouponDiscount"),v=document.querySelector(".checkIdBtn"),l=document.querySelector(".checkIdText"),f=document.querySelector(".couponList"),C=document.querySelector(".cancelCouponBtn"),$=document.querySelector(".checkCouponBtn"),s="https://dealmealserver.onrender.com",a=Swal.mixin({toast:!0,position:"top",showConfirmButton:!1,timer:1e3,timerProgressBar:!1,didOpen:t=>{t.onmouseenter=Swal.stopTimer,t.onmouseleave=Swal.resumeTimer}});y();function y(){axios.get(`${s}/coupons`).then(function(t){w(t.data)}).catch(function(t){console.log(t)})}function w(t){let n="",o="";t.forEach(function(e){e.state=="發佈中"?o=`
        ...
        `}),f.innerHTML=n}v.addEventListener("click",function(t){axios.get(`${s}/coupons`).then(function(n){let o=!0;n.data.forEach(function(e){i.value==e.id&&(o=o&&!1)}),o?l.innerHTML=' <p class="fs-7 text-success">此序號可以使用</p>':l.innerHTML=' <p class="fs-7 text-danger">此序號已重複</p>'}).catch(function(n){console.log(n)})});C.addEventListener("click",function(){c.reset()});$.addEventListener("click",function(t){t.preventDefault();const n={發佈日期:{presence:{allowEmpty:!1,message:"是必填欄位"}}},o={優惠碼序號:{presence:{allowEmpty:!1,message:"是必填欄位"}}},e=validate(c,n),r=validate(c,o),h=d.value=="請選擇",m=u.value=="請選擇",g=p.value=="請選擇";e?a.fire({icon:"warning",title:`${e.發佈日期}`}):r?a.fire({icon:"warning",title:`${r.優惠碼序號}`}):h||m||g?a.fire({icon:"warning",title:"尚有欄位未選擇"}):k()});function k(){axios.post(`${s}/coupons`,{id:i.value,date:b.value,name:d.value,usage:u.value,discount:p.value,state:"發佈中",useCount:0}).then(function(t){a.fire({icon:"warning",title:"發佈成功"}).then(n=>{window.location.href="admin-coupon.html"})}).catch(function(t){console.log(t),a.fire({icon:"error",title:"發佈失敗"})})}f.addEventListener("click",function(t){if(t.preventDefault(),t.target.innerHTML=="確認"){let n=t.target.getAttribute("data-js-state"),o=t.target.getAttribute("data-js-switchState");n=="發佈中"?axios.patch(`${s}/coupons/${o}`,{state:"停用中"}).then(function(e){window.location.href="admin-coupon.html"}).catch(function(e){console.log(e)}):axios.patch(`${s}/coupons/${o}`,{state:"發佈中"}).then(function(e){window.location.href="admin-coupon.html"}).catch(function(e){console.log(e)})}});
