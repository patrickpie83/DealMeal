import"./bootstrap.min-d005857b.js";import"./header-4ab9cc05.js";const h=document.querySelector(".logoutBtn"),d=document.querySelector(".memberFile"),f=document.querySelector("#memberName"),p=document.querySelector("#memberEmail"),y=document.querySelector("#memberAddress"),v=document.querySelector(".saveFileComfirm"),u=document.querySelector(".historyOrderContent");let i;const $="https://dealmealserver.onrender.com",g=Swal.mixin({toast:!0,position:"top",showConfirmButton:!1,timer:1e3,timerProgressBar:!1,didOpen:t=>{t.onmouseenter=Swal.stopTimer,t.onmouseleave=Swal.resumeTimer}});E();function E(){i=localStorage.getItem("userId"),i?S():window.location.href="login.html"}function S(){axios.get(`${$}/users/${i}`).then(function(t){b(t.data)}).catch(function(t){console.log(t)})}function b(t){f.value=t.name,p.value=t.email,y.value=t.address;let n="",s=t.historyOrder;s.length==0?u.innerHTML=`
        <tr>
