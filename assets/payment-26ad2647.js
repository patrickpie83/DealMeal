import"./bootstrap.min-d005857b.js";import"./header-d8c8e62b.js";const C=document.querySelector(".paymentItemsContent"),f=document.querySelector(".couponContent"),S=document.querySelector(".deliverNameContent"),I=document.querySelector(".deliverEmailContent"),q=document.querySelector(".deliverTelContent"),b=document.querySelector(".deliverAddressContent"),P=document.querySelector(".totalPriceContent"),w=document.querySelector("#linePay"),A=document.querySelector("#jkoPay"),E=document.querySelector("#applePay"),m=document.querySelector(".confrimBtn"),O=document.querySelector(".sendOrderBtn");let i=localStorage.getItem("userId");const r="http://localhost:3000",g=Swal.mixin({toast:!0,position:"top",showConfirmButton:!1,timer:1e3,timerProgressBar:!1,didOpen:t=>{t.onmouseenter=Swal.stopTimer,t.onmouseleave=Swal.resumeTimer}});T();let c;function T(){axios.get(`${r}/carts/${i}`).then(function(t){c=t.data,k(t.data)}).catch(function(t){console.log(t)})}function k(t){let o="";t.cart.forEach(function(e){o+=`
