    ...
    data.cart.forEach(function(item){
        ...
        <div class="row py-4 justify-content-center border border-top-0 border-dark-brown">
            ...
            <div class="w-50 text-center">
                <p class="text-normal-brown">${item.productSeries}</p>
            ...
            <div class="col-7 col-md-2 my-auto">
                <input data-js="quantityInput" data-cartItemId="${item.cartItemId}" class="w-100 " type="number" value="${item.quantity}" min="1">
            </div>
