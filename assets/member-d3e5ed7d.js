import"./bootstrap.min-d005857b.js";import"./header-4ab9cc05.js";const g=document.querySelector(".logoutBtn"),c=document.querySelector(".memberFile"),p=document.querySelector("#memberName"),y=document.querySelector("#memberEmail"),$=document.querySelector("#memberAddress"),v=document.querySelector(".saveFileComfirm"),f=document.querySelector(".historyOrderContent");let d;const h="https://dealmealserver.onrender.com",a=Swal.mixin({toast:!0,position:"top",showConfirmButton:!1,timer:1e3,timerProgressBar:!1,didOpen:t=>{t.onmouseenter=Swal.stopTimer,t.onmouseleave=Swal.resumeTimer}});E();function E(){d=localStorage.getItem("userId"),d?w():window.location.href="login.html"}function w(){axios.get(`${h}/users/${d}`).then(function(t){S(t.data)}).catch(function(t){console.log(t)})}function S(t){p.value=t.name,y.value=t.email,$.value=t.address;let n="",s=t.historyOrder;s.length==0?f.innerHTML=`
        <tr>
